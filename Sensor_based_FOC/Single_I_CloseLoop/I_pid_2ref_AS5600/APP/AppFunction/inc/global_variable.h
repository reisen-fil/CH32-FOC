...
#define M_Ld                            (1.5*M_Ls)                  /* d-axis inductance (H), in SPMSM, Lq = Ld */ 
...
#define Series_idq_kp                   (MC_I_Bandwidth*M_Ld)       /* Series PI proportional gain */
#define Series_idq_ki                   (M_Rs*MC_PWM_Ts/M_Ld)       /* Series PI integral gain */

#define Parallel_idq_kp                 (MC_I_Bandwidth*M_Ld)       /* Parallel PI proportional gain */
...
/* LPF_1 */
#define MC_IdqLPF1_Ts                 (_IQ(MC_PWM_Ts))              /* First-order low-pass filter control period */
#define MC_IdqLPF1_Freq               (_IQ(50.0))                   /* First-order low-pass cutoff frequency -> 50Hz */
